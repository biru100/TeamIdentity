...
public class PlayerSwordTrainingAction : PlayerCardAction
{
    public static PlayerSwordTrainingAction GetInstance(CardTable dataTable, TargetData target)
    { return ObjectPooling.PopObject<PlayerSwordTrainingAction>().SetData(dataTable, target) as PlayerSwordTrainingAction; }
