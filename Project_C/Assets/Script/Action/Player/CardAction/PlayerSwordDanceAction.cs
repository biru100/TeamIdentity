...
public class PlayerSwordDanceAction : PlayerCardAction
{
    public static PlayerSwordDanceAction GetInstance(CardTable dataTable, TargetData target)
    { return ObjectPooling.PopObject<PlayerSwordDanceAction>().SetData(dataTable, target) as PlayerSwordDanceAction; }
