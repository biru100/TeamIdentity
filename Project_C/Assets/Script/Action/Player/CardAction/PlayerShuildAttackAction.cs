...
{
    public static PlayerShuildAttackAction GetInstance(CardTable dataTable, TargetData target)
    { return ObjectPooling.PopObject<PlayerShuildAttackAction>().SetData(dataTable, target) as PlayerShuildAttackAction; }
