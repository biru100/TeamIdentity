...
public class PlayerSwordBoomAction : PlayerCardAction
{
    public static PlayerSwordBoomAction GetInstance(CardTable dataTable, TargetData target)
    { return ObjectPooling.PopObject<PlayerSwordBoomAction>().SetData(dataTable, target) as PlayerSwordBoomAction; }
