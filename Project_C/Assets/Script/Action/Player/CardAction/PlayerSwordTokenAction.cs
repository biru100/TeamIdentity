...
public class PlayerSwordTokenAction : PlayerCardAction
{
    public static PlayerSwordTokenAction GetInstance(CardTable dataTable, TargetData target)
    { return ObjectPooling.PopObject<PlayerSwordTokenAction>().SetData(dataTable, target) as PlayerSwordTokenAction; }
